...
function Job() {
  ...
  navigator.clipboard.writeText(Job).then(() => {
    alert("Job YAML copied to clipboard!");
  });
};

const downloadYAML = () => {
  const blob = new Blob([job], { type: "text/yaml" });
...
`;
  return (
    <>
      <h1 className="text-center mt-5">Kubernetes Job Generator</h1>
      <p className="text-center mb-5">Generate a Kubernetes Job YAML file with custom metadata and labels.</p>
      <div className="container">
        ...
        <div className="result">
          ...
          <div className="cmds">
            <h5>Commands</h5>
            <div className="cmd bg-light mb-4 align-content-center " style={{width: "550px", height: "40px", textAlign: "center", borderRadius: "8px"}}>kubectl apply -f job.yaml</div>
            <div className="cmd bg-light mb-4 align-content-center" style={{width: "550px", height: "40px", textAlign: "center", borderRadius: "8px"}}>kubectl get jobs</div>
            <div className="cmd bg-light mb-4 align-content-center" style={{width: "550px", height: "40px", textAlign: "center", borderRadius: "8px"}}>kubectl get describe job {name}</div>
            <div className="cmd bg-light mb-4 align-content-center" style={{width: "550px", height: "40px", textAlign: "center", borderRadius: "8px"}}>kubectl delete -f job.yml</div>
          </div>
        </div>
      </div>
    </>
